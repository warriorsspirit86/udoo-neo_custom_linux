...
config_arg6='-Dccflags=-DDEBIAN -Wdate-time -D_FORTIFY_SOURCE=2 -g -O2 -fdebug-prefix-map=/build/perl-BghvoK/perl-5.26.1=. -fstack-protector-strong -Wformat -Werror=format-security'
